...
def main():
	...
	query_urls.append("https://query1.finance.yahoo.com/v8/finance/chart/AMZN?symbol=AMZN&period1=0&period2=9999999999&interval=1d&includePrePost=true&events=div%2Csplit")
